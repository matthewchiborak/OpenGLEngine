...
//void Scene::init(std::string name, float windowWidth, float windowHeight)
//{
//	this->name = name;
//	//camera = new Camera(glm::vec3(0, 1, -5), 70.0f, (float)windowWidth / (float)windowWidth, 0.01f, 1000.0f);
//	camera = new Camera(Vec9::createVec9(0, 1, -5, 0, 0, 1, 0, 1, 0), 70.0f, (float)windowWidth / (float)windowWidth, 0.01f, 1000.0f);
...
//	loadNextLevel = false;
//}
void Scene::baseInit(std::string name, std::string fileName, float windowWidth, float windowHeight)
{
	this->name = name;
...
void Scene::baseUpdate(Display* display)
{
	update();
